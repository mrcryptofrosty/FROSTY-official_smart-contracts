...
const FrostyGenesisNFT = artifacts.require('FrostyGenesisNFTMock');
const ERC721ReceiverMock = artifacts.require('ERC721ReceiverMock');

contract('Core ERC721 behaviour tests for FrostyGenesisNFT', function ([owner, approved, anotherApproved, operator, other, multisig, buyer]) {

    const name = 'FrostyGenesis';
    const symbol = 'FST';
    ...
    beforeEach(async function () {
        this.accessControls = await FrostyAccessControls.new({from: owner});

        this.token = await FrostyGenesisNFT.new(
